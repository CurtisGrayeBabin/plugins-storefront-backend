...
var show = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, orders.show(Number(req.params.id))];
            case 1:
                order = _a.sent();
                res.json(order);
                return [3 /*break*/, 3];
...
var destroy = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, orders["delete"](Number(req.params.id))];
            case 1:
                deleted = _a.sent();
                res.json(deleted);
                return [3 /*break*/, 3];
...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, orders.update(Number(req.params.id), req.body.user_id, req.body.order_status)];
            case 1:
                updated = _a.sent();
                res.json(updated);
                return [3 /*break*/, 3];
...
var addPlugin = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var addedProduct, err_6;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
