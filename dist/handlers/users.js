...
var userTable = new users_1.Users();
var index = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, userTable.index()];
            case 1:
                users = _a.sent();
                res.json(users);
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, userTable.create(u)];
            case 1:
                newUser = _a.sent();
...
var show = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, userTable.show(Number(req.params.id))];
            case 1:
                user = _a.sent();
                res.json(user);
                return [3 /*break*/, 3];
...
var destroy = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, userTable["delete"](Number(req.params.id))];
            case 1:
                deleted = _a.sent();
                res.json(deleted);
                return [3 /*break*/, 3];
...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, first_name, last_name, username, pass, updated, err_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                username = req.body.username;
                pass = req.body.pass;
                return [4 /*yield*/, userTable.update(Number(id), first_name, last_name, username, pass)];
            case 1:
                updated = _a.sent();
                res.json(updated);
                return [3 /*break*/, 3];
